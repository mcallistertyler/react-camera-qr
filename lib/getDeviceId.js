...
var getFacingModePattern = function getFacingModePattern(facingMode) {
  return facingMode === 'environment' ? /rear|back|environment|bak/gi : /front|user|face|foran/gi;
};

function getDeviceId(facingMode, chosenCamera) {
  var chooseDeviceId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultDeviceIdChooser;
